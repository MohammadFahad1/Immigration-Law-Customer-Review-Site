...
const HeroSection = () => {
    return (
        <section className="text-gray-50 body-font bg-slate-900">
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    <h1 className="title-font sm:text-5xl text-3xl mb-4 font-medium text-gray-50">I am <span className="text-blue-500">Md. Fahad Monshi</span></h1>
                    <p className="mb-8 leading-relaxed">I Provide the best service in the town, in the most affordable price.</p>
                    <div className="flex w-full md:justify-start justify-center items-end">
                        <div className="relative mr-4 md:w-full lg:w-full xl:w-1/2 w-2/4">
                            <label for="hero-field" className="leading-7 text-sm text-gray-600">Search What Service You're Looking For ?</label>
